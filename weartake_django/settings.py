"""
Django settings for weartake_django project.
...
SECRET_KEY = 'django-insecure-71phj0bi998bgt5d%j+^-egi2@=#o0r)leo1(%z#)@%4_3i#$('
...
ROOT_URLCONF = 'weartake_django.urls'
...
WSGI_APPLICATION = 'weartake_django.wsgi.application'
